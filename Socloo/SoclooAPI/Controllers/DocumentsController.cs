...
namespace SoclooAPI.Controllers
{
    ...
    {
        public DocumentsController(IConfiguration config, ILogger<UsersController> logger, DataContext context) :
        ...
        [HttpPut("{id}")]
        async public Task<bool> Put(string _id, [FromBody] Document doc)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<bool> DeleteById(string id, [FromBody] Document doc)
        {
            try
            {
                var document = new BsonDocument
